...
$observacoes = "• Conclusão do Ensino Fundamental mediante Exames de Conclusão da EJA, conforme Art. 38 da Lei Federal nº 9.394/96.\n"
...
if ($urlFundoHistorico === '') {
    ...
    $urlFundoHistorico = $baseUrlSistema . '/sistema/img/historico_fundamental_fundo.jpg';
}
  ...
  <div class="pagina<?php echo $classeMarcaDagua; ?>">
    ...
    <div class="conteudo">
      ...
      <div class="titulo-doc">
        ...
        <div class="t2">EDUCAÇÃO DE JOVENS E ADULTOS - EJA - ENSINO FUNDAMENTAL - 2º SEGMENTO</div>
      </div>
