...
if ($status === 'duplicado') {
    $mensagem = 'Ja existe uma configuracao para esse nivel.';
    $classeMensagem = 'alert-warning';
}
if ($status === 'invalido') {
    $mensagem = 'Dados invalidos. Confira os campos e tente novamente.';
    $classeMensagem = 'alert-danger';
}?>

<div class="bs-example widget-shadow" style="padding:15px;">
    <div class="modal-header">
        <h4 class="modal-title">Adicionar comissao</h4>
    </div>
    ...
    <form method="POST" action="paginas/asaas_comissoes/inserir.php" style="margin-top: 15px;">
        <div class="row">
            <div class="col-md-5">
...
<div class="bs-example widget-shadow" style="padding:15px; margin-top: 15px;">
    <form method="POST" action="paginas/asaas_comissoes/alterar_registros.php" id="form-alterar-registros">
                    ...
                    <tr>
                        ...
                        <td class="esc" style="width: 200px;">
                            <select class="form-control" name="registros[<?php echo $id ?>][recebeSempre]">
                                ...
                                <option value="0" <?php echo $recebeSempre === 0 ? 'selected' : '' ?>>Nao</option>
                            </select>
                        </td>
        ...
        <button type="submit" class="btn btn-primary" onclick="return salvarComissoes();">Salvar alteracoes</button>
    </form>
</div>

<script>
function excluirComissao(id) {
    if (!confirm('Confirma a exclusao dessa configuracao?')) {
        return false;
    }
