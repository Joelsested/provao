...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: ../../index.php?pagina=asaas_comissoes&status=invalido');
    exit();
}
...
if ($stmtExiste->fetchColumn()) {
    header('Location: ../../index.php?pagina=asaas_comissoes&status=duplicado');
    exit();
}
...
header('Location: ../../index.php?pagina=asaas_comissoes&status=ok');
exit();