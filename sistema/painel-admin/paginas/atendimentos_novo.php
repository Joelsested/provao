			...
			<form method="post" id="form">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div id="divImg">
								<img src="<?php echo $url_sistema; ?>sistema/painel-admin/img/perfil/sem-perfil.jpg" width="100px" id="target">
							</div>
						</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row" style="border-bottom: 1px solid #cac7c7;">
					<div class="col-md-3">
						<span><b>Órgão Expedidor: </b></span>
						<span id="orgao_expedidor_mostrar"></span>
					</div>
					<div class="col-md-3">
