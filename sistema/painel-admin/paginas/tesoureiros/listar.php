...
<tr class="{$classe_linha}"> 
		<td>
		<img src="../painel-admin/img/perfil/{$foto}" width="50px" height="60px" class="mr-2">
		{$nome}	
		</td> 
		<td class="esc">
		{$telefone}
		...
		<big><a href="#" onclick="mostrar('{$nome}', '{$cpf}', '{$nascimento}', '{$email}','{$telefone}','{$endereco}','{$cidade}','{$estado}','{$sexo}', '{$foto}', '{$dataF}', '{$cartao}', '{$ativo}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
