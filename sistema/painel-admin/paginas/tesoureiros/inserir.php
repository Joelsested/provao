...
if ($id == "") {
    ...
    $query = $pdo->prepare("INSERT INTO usuarios SET wallet_id = :wallet_id, nome = :nome, usuario = :email, senha = '', cpf = :cpf, senha_crip = :senha_crip, nivel = 'Tesoureiro',  foto = :foto, id_pessoa = :id_pessoa, ativo = 'Sim', data = curDate()");
