...
$responsavel_id = (int) ($resposta_aluno[0]['responsavel_id'] ?? 0);
if ($responsavel_id <= 0) {
  $responsavel_id = (int) ($resposta_aluno[0]['usuario'] ?? 0);
}
if (in_array($nivel_usuario, ['Vendedor', 'Tutor', 'Parceiro', 'Secretario', 'Tesoureiro'], true)) {
