                ...
                <div>
                    ...
                    try {
                        $stmtDocs = $pdo->prepare("
                            ...
                            WHERE d.aluno_id = :aluno_id AND d.tipo = 'historico' AND d.categoria = 'fundamental'
...
?>
    ...
    <script>
        ...
        const materias = {
            ...
            'humanas': ['História', 'Geografia', 'Ciências'],
            'diversificada': [
                'Língua inglesa',
        ...
        const mapeamentoCursos = {
            ...
            // Cursos Fundamentais
            'lingua_portuguesa_fundamental': 'Língua portuguesa',
            'matematica_fundamental': 'Matemática',
            ...
            'historia_fundamental': 'História',
            'filosofia_fundamental': 'Filosofia',
            'historia_de_rondonia_fundamental': 'História do Estado de Rondônia',
            'geografia_de_rondonia_fundamental': 'Geografia do Estado de Rondônia',
            'lingua_espanhola_fundamental': 'Língua espanhola',
            'quimica_fundamental': 'Química',
        ...
        function formatarMateria(materia) {
            return materia
                ...
                + '_fundamental';                              // adiciona "_medio" ao final
        }
