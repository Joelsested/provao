...
$query = $pdo->prepare("SELECT * FROM $tabela where vencimento >= :data_inicial and vencimento <= :data_final and descricao = 'Comissão' and pago = 'Não' and professor LIKE :professor ORDER BY id desc");
$query->execute([
