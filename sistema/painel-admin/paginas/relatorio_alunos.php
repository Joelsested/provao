...
$itens_opcoes = [10, 25, 50, 100];
$itens_por_pagina = (int) ($_GET['itens'] ?? 10);
if (!in_array($itens_por_pagina, $itens_opcoes, true)) {
    $itens_por_pagina = 10;
}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="itens" id="itens">
                        <?php foreach ($itens_opcoes as $opcao) : ?>
                            <option value="<?php echo $opcao; ?>" <?php echo ($itens_por_pagina === $opcao) ? 'selected' : ''; ?>>
                                <?php echo $opcao; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
...
<div class="bs-example widget-shadow" style="padding:15px" id="listar">
        ...
        <?php if (count($res) > 0): ?>
            <?php foreach ($res as $dado): ?>
                <tr>
                    ...
                    ?>
                    <td><?= htmlspecialchars($cursoNome) ?></td>
    ...
    <?php if ($paginas > 1): ?>
        ...
        $baseParams['itens'] = $itens_por_pagina;
        if ($nivel_responsavel !== '') {
