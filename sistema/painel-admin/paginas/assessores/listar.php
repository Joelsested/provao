...
<tr class="{$classe_linha}"> 
		...
		<td>
		<big><a href="#" onclick="editar('{$id}', '{$nome}', '{$cpf}','{$email}','{$telefone}', '{$nascimento}', '{$foto}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, nome, cpf, email, telefone, nascimento, foto){
