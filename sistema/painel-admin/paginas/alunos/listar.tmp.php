      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
           ...
           <!-- Edit Data -->
		   <div class="col-md-4 text-center mb-3">
              <a href="#" onclick='editarAluno({$alunoJsonAttr})' class="btn btn-default btn-block" data-dismiss="modal">
                ...
                render: function (data, type, row) {
                    if (type === 'filter') {
                        ...
                        let semAcento = original
                            .normalize('NFD')
                            .replace(/[\u0300-\u036f]/g, '');
                        // retorna o original + uma c?pia sem acento
...
<script type="text/javascript">
	...
	function editar(id, nome, cpf, email, telefone, rg, orgao_expedidor, expedicao, nascimento, cep, sexo, endereco, numero, bairro, cidade, estado, mae, pai, naturalidade, responsavel_id, responsavel_nome, responsavel_nivel, responsavel_professor, data_transferencia_atendente, foto,) {
