            ...
            <form method="post" id="form">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Comissão Meus Alunos (%)</label>
                                <input type="number" class="form-control" name="comissao_meus_alunos" id="comissao_meus_alunos" step="0.01" min="0">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Comissão Outros Alunos (%)</label>
                                <input type="number" class="form-control" name="comissao_outros_alunos" id="comissao_outros_alunos" step="0.01" min="0">
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" style="border-bottom: 1px solid #cac7c7;">
                    <div class="col-md-6">
                        <span><b>Comissão Meus Alunos: </b></span>
                        <span id="comissao_meus_alunos_mostrar"></span>%
                    </div>
                    <div class="col-md-6">
                        <span><b>Comissão Outros Alunos: </b></span>
                        <span id="comissao_outros_alunos_mostrar"></span>%
                    </div>
                </div>
