...
@session_start();
$ocultar_excluir = (@$_SESSION['nivel'] === 'Administrador') ? '' : 'ocultar';
...
<tr class="{$classe_linha}"> 
		...
		<img src="{$caminho}" width="30px" height="30px" class="mr-2">
		...
		<button type="button" class="btn btn-sm btn-danger {$ocultar_excluir}"
		onclick="if(confirm('Confirmar exclusao?')) { excluir('{$id}'); }"
		>
           Excluir
        </button>
