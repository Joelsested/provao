                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="comissao_meus_alunos" id="comissao_meus_alunos">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="comissao_outros_alunos" id="comissao_outros_alunos">
                            </div>
                        </div>
                    </div>
