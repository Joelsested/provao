...
$html = utf8_encode(file_get_contents($url_sistema . "sistema/rel/declaracao_matriculado_fundamental.php?id=$id&data=$data_certificado&ano=$ano_certificado"));
...
// NOMEAR O PDF GERADO
$pdf->stream(
    'Declaracao Matriculado Fundamental.pdf',
