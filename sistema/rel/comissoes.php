...
<div class="titulo_cab titulo_img"><u>Relatério de Comissões <?php echo $acao_rel ?> <?php echo $nome_professor ?> </u></div>	
	...
	<div class="mx-2" style="padding-top:10px ">
		...
		$total_a_pagar = 0;
		$total_a_pagarF = 0;
		$query = $pdo->prepare("SELECT * from pagar where (vencimento >= :data_inicial and vencimento <= :data_final) and pago LIKE :pago and professor LIKE :professor order by id desc ");
		$query->execute([
	...
	<div class="col-md-12 p-2">
		...
		<span class="text-danger"> <small><small><small><small>TOTAL ? PAGAR</small> : R$ <?php echo $total_a_pagarF ?></small></small></small>  </span>			
