...
function nota_para_extenso($notaFormatada)
{
    ...
    if ($decimal !== '' && preg_replace('/0/', '', $decimal) !== '') {
        ...
        if (count($digitos) > 0) {
            $resultado .= ' vÃ­rgula ' . implode(' ', $digitos);
        }
    }
...
function localizar_fundo_eliminacao_fundamental()
{
    $pasta = __DIR__ . '/../img/';
    if (!is_dir($pasta)) {
        return null;
    ...
    foreach ($arquivos as $arquivo) {
        ...
        if (strpos($normalizado, 'elimin') !== false && strpos($normalizado, 'fundamental') !== false) {
            return $arquivo;
        }
    }
...
$mapaAliasesComponentes = [
    ...
    'ciencias' => ['ciencias', 'biologia', 'quimica', 'fisica'],
    'historia' => ['historia'],
    'geografia' => ['geografia'],
];
...
$fundoDetectado = localizar_fundo_eliminacao_fundamental();
$fundoFrenteNome = $fundoDetectado ?: resolver_nome_fundo([
    'eliminacao fundamental.jpg',
    'eliminacao fundamental_frente.jpg',
    'eliminacao_fundamental_frente.jpg',
]);
...
.cabecalho { text-align: center; font-size: 12px; line-height: 1.1; }
.cabecalho .nome {
    font-weight: 700;
    font-size: 14px;
    margin-bottom: 1.8mm;
...
<div class="documento">
    <div class="conteudo-principal">
        ...
        <div class="titulo">ATESTADO DE ELIMINA&Ccedil;&Atilde;O - EXAMES DE CONCLUS&Atilde;O DO ENSINO FUNDAMENTAL</div>
        ...
        <div class="texto">
            ...
            Exames de Conclus&atilde;o da EJA na etapa de Ensino Fundamental, bem como o cumprimento dos demais requisitos
            legais, <b>ATESTAMOS</b> para os devidos fins, que <b><?php echo htmlspecialchars($nome); ?></b>,
            CPF n&ordm;, <?php echo htmlspecialchars($cpf); ?>,
...
$gruposTabela = [
    [
        'area' => 'LINGUAGENS',
        'linhas' => [
            ['chave' => 'lingua_portuguesa', 'componente' => 'L&iacute;ngua Portuguesa'],
            ['chave' => 'arte', 'componente' => 'Arte'],
            ['chave' => 'educacao_fisica', 'componente' => 'Educa&ccedil;&atilde;o F&iacute;sica'],
        ],
    ],
    [
        'area' => 'MATEM&Aacute;TICA',
        'linhas' => [
            ['chave' => 'matematica', 'componente' => 'Matem&aacute;tica'],
        ],
    ],
    [
        'area' => 'CI&Ecirc;NCIAS DA NATUREZA',
        'linhas' => [
            ['chave' => 'ciencias', 'componente' => 'Ci&ecirc;ncias'],
        ],
    ],
    [
...
?>
    ...
    <div class="rodape-documento">
        <div class="observacoes">
            Observa&ccedil;&otilde;es: Crit&eacute;rio de aprova&ccedil;&atilde;o: nota m&iacute;nima 5,0 (cinco) em escala de 0 a 10, ou 50% de acertos nas avalia&ccedil;&otilde;es, em conformidade com o Art. 124 do Regimento Escolar.
        </div>
