...
$fundo_declaracao = rtrim((string) $url_sistema, '/') . '/sistema/img/' . rawurlencode('declaração-medio.jpg');
?>
...
<div class="assinatura">
	...
	<div class="cargo">Secretária</div>
</div>
