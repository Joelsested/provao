	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.php"><span class="fa fa-book"></span> Sested <span class="dashboard_text"></span></a></h1>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="index.php?pagina=outros_alunos">
                <i class="fa fa-users"></i> <span>Outros Alunos</span>
                </a>
              </li>
		...
		<div class="footer">
	   <small><p><?php echo $nome_sistema ?> - Desenvolvedor - Joel Souza - <a href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $tel_whatsapp ?>" title="Chamar no Whatsapp" target="_blank"><i class="fa fa-whatsapp" style="margin-right: 3px"></i><?php echo $tel_sistema ?></a></p>	</small>	
	</div>
					...
					<div class="modal-body">
						...
						<div class="row">							
							...
							<div class="col-md-4">
								<div class="form-group"> 
									<label>Sexo</label> 
									<input type="text" class="form-control" id="sexo_usu" name="sexo_usu" value="<?php echo $sexo_usu ?>" placeholder=""> 
								</div>
							</div>
