...
for($i=0; $i < $total_reg; $i++){
	...
	$query2 = $pdo->prepare("SELECT * FROM professores where id = :id");
...
<tr> 
		...
		<big><a class='{$ocul}' href="{$url_sistema}/sistema/rel/avaliacoes_class2.php?id={$id_usuario}&id_curso={$curso}" target="_blank" title="Avaliações do aluvas">
		...
		<big><a class="{$icones_finalizados} {$ocultar_avaliar}" href="#" onclick="avaliar('{$curso}', '{$nome_curso}')" title="Avaliar Curssso"><i class="fa fa-star amarelo"></i></a></big>
