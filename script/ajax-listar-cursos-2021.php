...
$limite = (int) ($pagina * $itens_pag);
$itens_pag = (int) $itens_pag;



 $query = $pdo->prepare("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and ano = '2021' and (nome LIKE :busca or desc_rapida LIKE :busca) ORDER BY id desc LIMIT $limite, $itens_pag");
...
$query2->execute([':curso' => $id]);
     ...
     $query2 = $pdo->prepare("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and ano = '2021' and (nome LIKE :busca or desc_rapida LIKE :busca) ORDER BY id desc "\);
