...
$itens_pag = (int) $itens_pag;
 ...
 $query = $pdo->prepare("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and (nome LIKE :busca or desc_rapida LIKE :busca) ORDER BY id desc LIMIT $limite, $itens_pag");
...
for($i=0; $i < $total_reg; $i++){
    ...
    if($promocao > 0){
     ...
     $query2 = $pdo->prepare("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and (nome LIKE :busca or desc_rapida LIKE :busca) ORDER BY id desc "\);
